...
- *Multidimensional case* (Euclidean clouds, see pp. 55–59) — reference data ("Target" example): [`Target_reference.txt`](/data/Target_reference.txt) ; group data: [`Target_group.txt`](/data/Target_group.txt) ; R script: [`Combinatorial_Typicality.R`](/data/Combinatorial_Typicality.R).
...
- *Multidimensional case* (Euclidean clouds) — "Target" example data: [`Target.txt`](/data/Target.txt) ; R script (pp. 97–101): [`Geometric_Typicality.R`](/data/Geometric_Typicality.R).
...
- *Design with two repeated measures* — Student's example: [`Student.txt`](/data/Student.txt).
...
- Data (p. 142): [`Target_4.txt`](/data/Target_4.txt)
- R script (pp. 142–147, partial or specific comparison of two independent groups): [`Homogeneity.R`](/data/Homogeneity.R)
...
- Combinatorial typicality tests (Chapter 3): [`CIGDA_combi.zip`](/data/CIGDA_combi.zip)
- Combinatorial typicality tests — SPAD-interfaced script: [`CIGDA_Comb-v1.1.R`](/data/CIGDA_Comb-v1.1.R)
- Geometric typicality test (Chapter 4) — SPAD-interfaced script: [`CIGDA_Geo-v1.R`](/data/CIGDA_Geo-v1.R)
- Homogeneity permutation tests (Chapter 5) — SPAD-interfaced script: [`CIGDA_Homog-v1.R`](/data/CIGDA_Homog-v1.R)
...
1. **The Parkinson Study** — data: [`Parkinson.xls`](/data/Parkinson.xls); SPAD project: [`The Parkinson Study`](/data/The_Parkinson_Study_2019_03_31.spad)
2. **Members of French Parliament and Globalisation** — data: [`MPs&Globalisation.xls`](/data/MPs%26Globalisation.xls); SPAD project: [`MPs-Globalisation`](/data/MPs-Globalisation_2019_03_31.spad)
3. **The European Central Bankers Study** — data and SPAD project available on request from Frédéric Lebaron.
4. **Cognitive Tests and Education** — data: [`CognitiveTests.xls`](/data/CognitiveTests.xls); SPAD project: [`Cognitive Study`](/data/Cognitive_Study_2019_01_01.spad)
