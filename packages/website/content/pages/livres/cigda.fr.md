...
- *Cas multidimensionnel* (nuages euclidiens) — données de référence (exemple « Cible ») : [`Target_reference.txt`](/data/Target_reference.txt) ; données du groupe : [`Target_group.txt`](/data/Target_group.txt) ; script R des pages 55 à 58 : [`Combinatorial_Typicality.R`](/data/Combinatorial_Typicality.R).
...
- *Cas multidimensionnel* (nuages euclidiens) — données de l'exemple « Cible » : [`Target.txt`](/data/Target.txt) ; script R des pages 97 à 101 : [`Geometric_Typicality.R`](/data/Geometric_Typicality.R).
...
- *Plan avec deux mesures répétées* — données de Student : [`Student.txt`](/data/Student.txt).
...
- Données (p. 142) : [`Target_4.txt`](/data/Target_4.txt)
- Script R des pages 142–147 (comparaison partielle ou spécifique de deux groupes indépendants) : [`Homogeneity.R`](/data/Homogeneity.R)
...
- Tests combinatoires de typicalité (chapitre 3) : [`CIGDA_combi.zip`](/data/CIGDA_combi.zip)
- Tests combinatoires de typicalité — script interfacé SPAD : [`CIGDA_Comb-v1.1.R`](/data/CIGDA_Comb-v1.1.R)
- Test géométrique de typicalité (chapitre 4) — script interfacé SPAD : [`CIGDA_Geo-v1.R`](/data/CIGDA_Geo-v1.R)
- Tests d'homogénéité (chapitre 5) — script interfacé SPAD : [`CIGDA_Homog-v1.R`](/data/CIGDA_Homog-v1.R)
...
1. **L'étude Parkinson** — données : [`Parkinson.xls`](/data/Parkinson.xls) ; projet SPAD : [`The Parkinson Study`](/data/The_Parkinson_Study_2019_03_31.spad)
2. **Les députés et la mondialisation** — données : [`MPs&Globalisation.xls`](/data/MPs%26Globalisation.xls) ; projet SPAD : [`MPs-Globalisation`](/data/MPs-Globalisation_2019_03_31.spad)
3. **Les banquiers centraux européens** — données et projet SPAD sur demande auprès de Frédéric Lebaron.
4. **Tests cognitifs et éducation** — données : [`CognitiveTests.xls`](/data/CognitiveTests.xls) ; projet SPAD : [`Cognitive Study`](/data/Cognitive_Study_2019_01_01.spad)
