...
portrait:
  src: https://brigitte-le-roux.com/data/photoweb.jpg
...
tiles:
  ...
  methodes:
    title: Méthodes
    items:
      - label: Analyse des correspondances multiples
        ab: ACM
      - label: Analyse en composantes principales
        ab: ACP
      - label: Données structurées
        ab: —
      - label: Inférence combinatoire
        ab: —
  nouveau:
    title: Nouveau
