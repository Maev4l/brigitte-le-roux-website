...
My research on inference in data analysis first addressed the extension of the *test value* notion for comparing groups in PCA and MCA (Chapter 4 of the HDR; [1998]). This line of work culminated in the book [*Combinatorial Inference in Geometric Data Analysis*](/livres/cigda) (Chapman & Hall/CRC, 2019), co-authored with Solène Bienaise and Jean-Luc Durand, which develops a combinatorial approach to typicality and homogeneity tests applied to Euclidean clouds.
