...
- *Cas multidimensionnel* (nuages euclidiens) — données de référence (exemple « Cible ») : [`Target_reference.txt`](/shared/data/livres/CIGDA/Data/Target_reference.txt) ; données du groupe : [`Target_group.txt`](/shared/data/livres/CIGDA/Data/Target_group.txt) ; script R des pages 55 à 58 : [`Combinatorial_Typicality.R`](/shared/data/livres/CIGDA/R_scripts/Combinatorial_Typicality.R).
...
- *Cas multidimensionnel* (nuages euclidiens) — données de l'exemple « Cible » : [`Target.txt`](/shared/data/livres/CIGDA/Data/Target.txt) ; script R des pages 97 à 101 : [`Geometric_Typicality.R`](/shared/data/livres/CIGDA/R_scripts/Geometric_Typicality.R).
...
- *Plan avec deux mesures répétées* — données de Student : [`Student.txt`](/shared/data/livres/CIGDA/Data/Student.txt).
...
- Données (p. 142) : [`Target_4.txt`](/shared/data/livres/CIGDA/Data/Target_4.txt)
- Script R des pages 142–147 (comparaison partielle ou spécifique de deux groupes indépendants) : [`Homogeneity.R`](/shared/data/livres/CIGDA/R_scripts/Homogeneity.R)
...
- Tests combinatoires de typicalité (chapitre 3) : [`CIGDA_combi.zip`](/shared/data/livres/CIGDA/R_scripts/CIGDA_combi.zip)
- Tests combinatoires de typicalité — script interfacé SPAD : [`CIGDA_Comb-v1.1.R`](/shared/data/livres/CIGDA/R_scripts/CIGDA_Comb-v1.1.R)
- Test géométrique de typicalité (chapitre 4) — script interfacé SPAD : [`CIGDA_Geo-v1.R`](/shared/data/livres/CIGDA/R_scripts/CIGDA_Geo-v1.R)
- Tests d'homogénéité (chapitre 5) — script interfacé SPAD : [`CIGDA_Homog-v1.R`](/shared/data/livres/CIGDA/R_scripts/CIGDA_Homog-v1.R)
...
1. **L'étude Parkinson** — données : [`Parkinson.xls`](/shared/data/Logiciels/Data/Parkinson.xls) ; projet SPAD : [`The Parkinson Study`](/shared/data/livres/CIGDA/Spad_Projects/The%20Parkinson%20Study_2019_03_31.spad)
2. **Les députés et la mondialisation** — données : [`MPs&Globalisation.xls`](/shared/data/livres/CIGDA/Data/MPs%26Globalisation.xls) ; projet SPAD : [`MPs-Globalisation`](/shared/data/livres/CIGDA/Spad_Projects/MPs-Globalisation_2019_03_31.spad)
3. **Les banquiers centraux européens** — données et projet SPAD sur demande auprès de Frédéric Lebaron.
4. **Tests cognitifs et éducation** — données : [`CognitiveTests.xls`](/shared/data/livres/CIGDA/Data/CognitiveTests.xls) ; projet SPAD : [`Cognitive Study`](/shared/data/livres/CIGDA/Spad_Projects/Cognitive%20Study_2019_01_01.spad)
